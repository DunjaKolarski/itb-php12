<?php
    ...
    class Film
    {
        ...
        {
            echo "<p>Film $this->naslov , reziser: $this->reziser, godina izdanja: $this->godinaIzdanja, ocene: ". implode(", ", $this->ocene) . "prosecna ocena: ". $this->prosek() . "</p>";
        }
        // od niza pravi string , razdvaja necim elemenete implode
