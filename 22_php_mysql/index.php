<?php
    ...
    $res = $conn->query($q); // odgovor ovoga je objekat res

    // da li ima ili nema takvih podataka?provera rezultata**
                              ...
                              else
                              {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="edit.php?id=<?php echo $row['id']?>" class="btn btn-succes">Izmena</a>
